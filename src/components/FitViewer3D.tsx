...
export const FitViewer3D: React.FC<FitViewer3DProps> = ({
  ...
  useEffect(() => {
    ...
    headGroup.rotation.set(0.08, -0.18, 0);
    rightArmGroup.rotation.set(-1.15, -0.42, 0.16);
    leftArmGroup.rotation.set(-0.92, 0.68, -0.26);
    rightLegGroup.rotation.set(0, 0, 0.03);
    leftLegGroup.rotation.set(0, 0, -0.04);
    ...
    const attachWeapon = (gltfGroup: THREE.Group) => {
      ...
      // Position directly across player hands and chest
      gunClone.position.set(1.5, -0.5, 7.2);
