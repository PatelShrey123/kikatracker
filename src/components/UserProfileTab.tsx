                ...
                {profile.clan && (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center space-x-1 text-gold-bright hover:text-gold-primary font-bold uppercase tracking-wider transition-colors hover:underline cursor-pointer"
                    >
